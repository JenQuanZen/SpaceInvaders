...
# 1 "start.h" 1
# 22 "start.h"
extern const unsigned short startTiles[752];
...
void goToStart() {
 ...
 DMANow(3, startTiles, &((charblock *)0x6000000)[0], 752);
...
void goToPause() {
 ...
 DMANow(3, pauseTiles, &((charblock *)0x6000000)[0], 688);


 DMANow(3, pauseMap, &((screenblock *)0x6000000)[31], 1024);
...
void goToWin() {
 ...
 DMANow(3, winTiles, &((charblock *)0x6000000)[0], 1808);
...
void goToLose() {
 ...
 DMANow(3, loseTiles, &((charblock *)0x6000000)[0], 2592);


 DMANow(3, loseMap, &((screenblock *)0x6000000)[31], 1024);
